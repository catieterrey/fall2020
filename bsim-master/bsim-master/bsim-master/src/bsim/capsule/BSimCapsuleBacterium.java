...
public class BSimCapsuleBacterium {
    ...
    // coordinate vectors for the endpoints of the bacterium
    public Vector3d x1 = new Vector3d(0,0,0);
    public Vector3d x2 = new Vector3d(0,0,0);

    // center of the bacterium. note that position = (x2-x1)/2
    public Vector3d position = new Vector3d(0,0,0);

    // force exerted on each endpoint of the bacterium
    ...
    // how large the orbs are at each endpoint)
    ...
    public double L_th = 7; //make sure L_max is greater than L_th
    ...
    public double k_filial = 0.0; //end to end attraction
    public double k_longfilial = 0.0; //opposite end repulsion when filial is active
    public double k_sticking = 0.0;   //side to side attraction
    public double k_wallstick = 0.00;  //cell to wall attraction (0 right now since walls are leaky)

    public double range_filial = 0.075; //maximum range at which filial forces activate
